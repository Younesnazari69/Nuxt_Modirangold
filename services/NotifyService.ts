...
/// *** End of toast/notification service code *** ///

// Initialise the CodePen UI buttons
// const svc: INotifyService = new NotifyService();

// var b1 = document.querySelector('#btnInfo');
// b1.onclick = () => svc.showInfo("Life", "Just letting you know that something took place over there...");

// var b2 = document.querySelector('#btnWarn');
// b2.onclick = () => svc.showWarning("Watch Out!", "Look out, look out there's something behind you!");

// var b3 = document.querySelector('#btnError');
// b3.onclick = () => svc.showError("Bad Stuff!!", "OMG Something really bad has happened.");
