...
function showMegamenuMenu(el) {
	...
	var mLeft = _menuPopupOffset.right - _mpadding + (_containerOffset.right - _mainOffset.right) + _containerLeftPadding;
	if (mLeft + pWidth > mWidth) var xLeft = mWidth - pWidth + (_containerOffset.right - _mainOffset.right) + _containerLeftPadding;
	else var xLeft = _menuPopupOffset.right - _mpadding + (_containerOffset.right - _mainOffset.right) + _containerLeftPadding;
